...
- Dùng model nhỏ cũng được, tuy nhiên sẽ phải ngồi sửa lỗi và xử lý các vấn đề lặt vặt mà model không nhận biết được.
...
Link github [full không che](https://github.com/thevivotran/studytest/blob/main/idea/1/idea_draft.md)
...
Link [GitHub](https://github.com/thevivotran/studytest/tree/main/flashcard_app) để tải dự án về dùng trên local. Trong repo đã có sẵn file hướng dẫn của `Agent Developer`, mọi người có thể làm theo.
...
Dataset mẫu có thể [tải tại đây](https://github.com/thevivotran/studytest/blob/main/my_flashcard_data/topics/GCP_DE_Pro.csv)
...
- Chi phí khá rẻ, một ly cà phê vỉa hè cho một web app đúng theo nhu cầu cá nhân, trong vòng 15 phút.
